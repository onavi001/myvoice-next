            ...
            case "casa":
                prompt = `
                    ...
                    **Instrucciones:**
                    ...
                    - Por ejercicio: "name" (ej. "Flexiones"), "muscleGroup" (array de músculos principales), "sets" (3-5), "reps" (fuerza: 6-10; hipertrofia: 10-15; resistencia: 15-20), "weight" ("0" para peso corporal, "2-10" si usa equipo ligero), "weightUnit" ("kg" o "n/a" para peso corporal), "rest" (fuerza: "60-90s"; hipertrofia: "45-60s"; resistencia: "30-45s"), "tips" (array con 2 consejos), "completed" (false), "videos" (array vacío), "notes" (string vacío o basado en las notas).
